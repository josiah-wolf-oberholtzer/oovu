...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.0, 65.0, 97.0, 18.0 ],
					"text" : "get membertype"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 65.0, 77.0, 18.0 ],
					"text" : "get datatype"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 10.0, 40.0, 199.0, 20.0 ],
					"text" : "route getdatatype getmembertype"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 15.0, 241.0, 20.0 ],
					"text" : "oovu.messaging.reply #1-attribute-interface"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 10.0, 95.0, 108.0, 20.0 ],
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 41.75, 121.0, 308.0, 121.0, 308.0, 10.0, 19.5, 10.0 ],
					"source" : [ "obj-2", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 109.5, 90.0, 19.5, 90.0 ],
					"source" : [ "obj-6", 0 ]
				}
