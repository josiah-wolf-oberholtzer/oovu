...
public class Line extends MaxObject implements Executable {
    ...
    @Override
    public void bang() {
        this.outlet(0, this.current_value);
    }
    ...
    public void execute() {
        ...
        float next_value = this.desired_value
            + (this.current_slope * next_time);
    ...
    public void list(int[] value) {
        ...
        this.current_slope = (this.starting_value - this.desired_value)
            / this.remaining_time;
        this.clock.delay(this.output_granularity);
    }
