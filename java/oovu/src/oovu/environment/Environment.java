...
public class Environment {
    ...
    public static final HashMap<String, AudioServer> pull_addresses = 
        new HashMap<String, AudioServer>();
    public static final HashMap<String, AudioServer> push_addresses = 
        new HashMap<String, AudioServer>();
    ...
    public static void reset() {
        ...
        Environment.root_server.attach_to_osc_address_node(
