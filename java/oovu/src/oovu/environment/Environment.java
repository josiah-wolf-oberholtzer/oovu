...
public class Environment {
    ...
    // public static final HashMap<String, Node> osc_addresses = new
    // HashMap<String, Node>();
    ...
    public static final HashMap<OscAddress, HashSet<Binding>> waiting_bindings = new HashMap<OscAddress, HashSet<Binding>>();
    static {
