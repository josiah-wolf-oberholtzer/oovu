...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "front" ],
					"patching_rect" : [ 10.0, 10.0, 152.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 10.0, 335.0, 252.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 270.0, 335.0, 340.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "" ],
					"patching_rect" : [ 10.0, 420.0, 285.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 470.0, 600.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 8,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 445.0, 252.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "oovu.property #1 allpass/delay/range @datatype range @default 0.1 0.3"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "oovu.property #1 allpass/gain/range @datatype range "
				}
...
, 			{
				"box" : 				{
					...
					"text" : "oovu.property #1 feedback/delay/range @datatype range "
				}
...
, 			{
				"box" : 				{
					...
					"text" : "oovu.property #1 feedback/gain/frequency @datatype decimal @unit hertz"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "oovu.property #1 feedback/delay/frequency @datatype decimal @unit hertz"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "oovu.property #1 allpass/gain/frequency @datatype decimal @unit hertz"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "oovu.property #1 allpass/delay/frequency @datatype decimal @unit hertz"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 600.5, 365.0, 285.5, 365.0 ],
					"source" : [ "obj-66", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 279.5, 375.0, 19.5, 375.0 ],
					"source" : [ "obj-66", 0 ]
				}
