...
public class Test__MultiEnvelope__unlace {
    ...
    public void test_02() {
        ...
        Assert.assertArrayEquals(new TimePoint[] {
            new TimePoint(1500., 1.), new TimePoint(3500., 2.), new TimePoint(6500., 3.)
        }, result[0]);
        Assert.assertArrayEquals(new TimePoint[] {
    ...
    public void test_03() {
        ...
        Assert.assertArrayEquals(new TimePoint[] {
            new TimePoint(1250., 1.), new TimePoint(3250., 2.), new TimePoint(6250., 3.)
        }, result[0]);
        Assert.assertArrayEquals(new TimePoint[] {
    ...
    public void test_04() {
        ...
        double[] control_values = new double[] {
            1., -1., 0.5, 1000., 2., -2., 1., 2000., 3., -3., 1.5, 3000., 666., 666.
        };
        double current_time = 250.;
        TimePoint[][] result = envelope.unlace(control_values, current_time, 3);
        Assert.assertEquals(3, result.length);
