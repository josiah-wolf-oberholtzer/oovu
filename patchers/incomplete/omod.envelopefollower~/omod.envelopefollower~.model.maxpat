...
, 			{
				"box" : 				{
					...
					"text" : "mxj oovu.Return #1 attack datatype: trigger"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "mxj oovu.Return #1 envelope datatype: decimal range: 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "poly~ omod.envelopefollower~.voix 1 @args #1"
				}
