...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 20.0, 685.0, 196.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 20.0, 625.0, 196.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 20.0, 665.0, 36.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 80.0, 110.0, 55.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 20.0, 605.0, 36.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 80.0, 90.0, 55.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 50.0, 575.0, 193.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 80.0, 130.0, 55.0, 15.0 ],
					"prototypename" : "M4L.toggle",
					"rounded" : 0.0,
					"text" : "Sends",
					"textcolor" : [ 0.101961, 0.121569, 0.172549, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 80.0, 150.0, 35.0, 55.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 65.0, 500.0, 16.0, 96.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 120.0, 150.0, 15.0, 55.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 115.0, 500.0, 191.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 65.0, 345.0, 16.0, 96.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 115.0, 345.0, 183.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 65.0, 315.0, 181.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 685.0, 580.0, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 25.0, 65.0, 35.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 680.0, 620.0, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 175.0, 35.0, 35.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 675.0, 615.0, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 25.0, 65.0, 185.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 29.5, 650.0, 14.0, 650.0, 14.0, 599.0, 29.5, 599.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 29.5, 711.0, 16.0, 711.0, 16.0, 659.0, 29.5, 659.0 ],
					"source" : [ "obj-50", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-33" : [ "live.numbox[16]", "live.numbox[4]", 0 ],
			"obj-38" : [ "live.numbox[17]", "live.numbox[4]", 0 ],
