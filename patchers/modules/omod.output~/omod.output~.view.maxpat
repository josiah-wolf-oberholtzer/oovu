...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 335.0, 60.0, 18.0 ],
					"text" : ":getmixer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 20.0, 360.0, 100.0, 20.0 ],
					"text" : "mxj oovu.Root"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 20.0, 310.0, 55.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 25.0, 30.0, 50.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 510.0, 610.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 510.0, 535.0, 100.0, 20.0 ],
					"text" : "mean"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 510.0, 510.0, 100.0, 20.0 ],
					"text" : "zl stream 5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 420.0, 530.0, 28.0, 16.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 480.0, 635.0, 110.0, 40.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 110.0, 70.0, 20.0 ],
					"setminmax" : [ 0.0, 100.0 ],
					"setstyle" : 3,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "AIFF" ],
					"patching_rect" : [ 140.0, 405.0, 43.0, 20.0 ],
					"text" : "t AIFF"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "bang" ],
					"patching_rect" : [ 140.0, 430.0, 105.0, 20.0 ],
					"text" : "savedialog sound"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 95.0, 615.0, 149.0, 33.0 ],
					"text" : "sprintf text %d:%.2d:%.2d.%.3d"
				}
...
,
					"patching_rect" : [ 95.0, 590.0, 149.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 470.0, 111.0, 20.0 ],
					"text" : "loadmess 0."
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 160.0, 45.0, 15.0 ],
					"prototypename" : "gain",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 420.0, 505.0, 79.0, 20.0 ],
					"text" : "prepend text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 420.0, 480.0, 155.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 155.0, 130.0, 50.0 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.0, 560.0, 28.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 90.0, 70.0, 15.0 ],
					"prototypename" : "M4L.display",
					"rounded" : 8.0,
					"text" : "0:00:00.000",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.0, 510.0, 55.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 140.0, 385.0, 55.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 95.0, 560.0, 185.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 95.0, 530.0, 212.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 140.0, 455.0, 189.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 415.0, 580.0, 183.0, 20.0 ],
					"text" : "mxj oovu.Proxy #1 dac/routing"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 420.0, 400.0, 179.0, 20.0 ],
					"text" : "mxj oovu.Proxy #1 dac/active"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 135.0, 130.0, 15.0 ],
					"rounded" : 0.0,
					"tabmode" : 0,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 80.0, 110.0, 55.0, 20.0 ],
					"prototypename" : "M4L.toggle",
					"rounded" : 0.0,
					"text" : "DSP INFO",
					"textcolor" : [ 0.101961, 0.121569, 0.172549, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 220.0, 360.0, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 405.0, 85.0, 16.0, 96.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 455.0, 85.0, 176.0, 33.0 ],
