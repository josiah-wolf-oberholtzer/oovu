...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 325.0, 240.0, 58.0 ],
					"text" : "/dsp/output.1/:interface destination dumpmeta getdestination getdestinationid getinterface getio getmeta getmodulename getoscaddress getuniqueid report show"
				}
